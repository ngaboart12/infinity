...
const ContactUs = () => {
  ...
  return (
    <div className=' relative  max-h-[150vh] ' >
      <div className='w-full flex px-2 sm:px-20 py-10 bg-[#56697A] justify-center' style={{backgroundImage: `url('../image/contactus.png')`,backgroundRepeat:'no-repeat',backgroundSize:'cover'}}>
