...
const Navbar = () => {
  return (
    <div className="py-[43px] px-6 sm:px-10 md:px-20 w-full flex justify-between">
        <a href=""><Image
            src={`/image/logo.png`}
            alt="logo"
            width={140}
        ...
        <div className="links hidden mdl:flex text-white text-sm text-[20px] gap-10 font-light items-center font-outfit">
