...
const Services = () => {
  ...
  return (
    <div className='p-10 mdl:p-10 min-h-[100vh] items-center justify-center' id="service">
        <div className='relative flex w-full min-h-[70vh] pb-10 pt-4 bg-[#848484]/20 rounded-md overflow-hidden'>
            ...
            <div className="z-10 w-full flex gap-6 items-center justify-center min-h-[70vh] pb-4">
                <div className="flex flex-col mdl:flex-row items-center mdl:items-start gap-10 px-6">
                    ...
                    <div className=" relative flex flex-col gap-6">
                        ...
                        <div className="grid  grid-cols-2 sm:grid-cols-3 gap-8">
                           {services1.map((item) => (
                                <div key={item.id} className="flex flex-col gap-2 max-w-[30vh]">
                                    <div className="h-14">
